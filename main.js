...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["HITLER (FROM HEAVEN)", "Chrome", "3.0"];
  ...
  client.on("open", () => {
    success("2", "Successfully connected to wa, HITLER");
